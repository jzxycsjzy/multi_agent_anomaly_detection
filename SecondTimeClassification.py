...
if __name__ == '__main__':
    ...
    clf2 = HistGradientBoostingClassifier(learning_rate=0.05, max_iter=300, l2_regularization=0.3, min_samples_leaf=2, verbose=1, max_leaf_nodes=256, early_stopping=False)
    clf2.fit(X_train, y_train)
    scores = clf2.score(X_test, y_test)
    scores.mean()
    res = clf2.predict(X_test)
    ...
    clf2 = HistGradientBoostingClassifier(learning_rate=0.05, max_iter=300, l2_regularization=0.35, min_samples_leaf=1, verbose=1, max_leaf_nodes=256, early_stopping=False)
    clf2.fit(X_train, y_train)
    scores = clf2.score(X_test, y_test)
    scores.mean()
    res = clf2.predict(X_test)
    ...
    clf2 = HistGradientBoostingClassifier(learning_rate=0.05, max_iter=300, l2_regularization=0.3, min_samples_leaf=1, verbose=1, max_leaf_nodes=256, early_stopping=False)
    clf2.fit(X_train, y_train)
    scores = clf2.score(X_test, y_test)
    scores.mean()
    res = clf2.predict(X_test)
    ...
    clf2 = HistGradientBoostingClassifier(learning_rate=0.05, max_iter=300, l2_regularization=0.4, min_samples_leaf=3, verbose=1, max_leaf_nodes=256)
    clf2.fit(X_train, y_train)
    scores = clf2.score(X_test, y_test)
    scores.mean()
    res = clf2.predict(X_test)
